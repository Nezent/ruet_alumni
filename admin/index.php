<?php include 'header.php'; ?>
  ...
  <path fill-rule="evenodd" d="M8 15a.5.5 0 0 0 .5-.5V2.707l3.146 3.147a.5.5 0 0 0 .708-.708l-4-4a.5.5 0 0 0-.708 0l-4 4a.5.5 0 1 0 .708.708L7.5 2.707V14.5a.5.5 0 0 0 .5.5z"/>
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Registers</h4>
							    <div class="stats-figure"><?php echo $conn->query("SELECT * FROM registers")->num_rows; ?></div>
			        ...
			        <div class="col-12 col-lg-6">
				        <div class="app-card app-card-stats-table h-100 shadow-sm">
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center">
							        <div class="col-auto">
						                <h4 class="app-card-title">Event Registers List</h4>
							        </div><!--//col-->
							        <div class="col-auto">
								        <div class="card-header-action">
							        ...
							        <table class="table table-borderless mb-0">
										<thead>
											<tr>
												...
												<th class="meta stat-cell">Email</th>
												<th class="meta stat-cell">Department</th>
											</tr>
										</thead>
										<tbody>
										<?php
											
											$alumni = $conn->query("SELECT * FROM registers");
											while($row = $alumni->fetch_assoc()):
											?>
											<tr>
												<td><a href="#"><?php echo $row['name'] ?></a></td>
												<td class="stat-cell"><?php echo $row['email'] ?></td>
												<td class="stat-cell"><?php echo $row['department'] ?></td>
											</tr>
